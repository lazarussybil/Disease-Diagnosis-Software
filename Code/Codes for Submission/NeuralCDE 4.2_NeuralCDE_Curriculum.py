...
def main(arg):
    ...
    train_datasets = KvasirVideoDataset(os.path.join(arg.video_img_dir, 'Train'), arg.img_input_size, False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type = str, default = f'Model\\NeuralCDE(1, 7)_{data_type}')
    ...
    parser.add_argument('--w', type = Tensor, default = torch.tensor([1, 7], dtype=torch.float))
